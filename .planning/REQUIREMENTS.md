...
- [x] **FALL-02**: In OmniJS fallback mode, urgency is fully populated; availability is reduced to `available` / `completed` / `dropped` (no `blocked`)
