...
**Goal**: New typed reference models and system location constants exist for all subsequent phases to import
**Depends on**: Nothing (first phase of v1.3.1)
...
Plans:
- [x] 39-01-PLAN.md — System location constants and reference models (ProjectRef, TaskRef, FolderRef)
...
- [ ] 40-03-PLAN.md — Gap closure: propagate RESERVED_PREFIX error through _process_anchor_move
...
| 40. Resolver | v1.3.1 | 2/3 | Gap closure | 2026-04-05 |
