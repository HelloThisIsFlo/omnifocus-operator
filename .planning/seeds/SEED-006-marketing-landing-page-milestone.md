...
trigger_when: v1.3.2 complete, before starting v1.4
scope: Large
---
...
- **Timing** — after v1.3/v1.3.2 (read tools, filtering, search), the feature set is substantial enough to market convincingly
...
**Trigger:** When v1.3.2 is complete and v1.4 planning begins

This seed should be presented during `/gsd:new-milestone` when the milestone scope matches any of these conditions:
- Post v1.3.2 milestone planning (primary trigger)
...
1. **Landing page overhaul** — update PAGE.md to reflect current features (v1.0-v1.3.2), architecture, benchmarks. Make it production-quality, not a rough draft.
...
- `.research/updated-spec/MILESTONE-v1.3.2.md` — Additional read tools
