...
**Important:** TaskPaper must carry hierarchy information by default. The format naturally does this via indentation — ensure this is preserved so agents can see parent/child structure without extra queries. This complements the `order` integer field (v1.3.1) which provides programmatic ordering.
