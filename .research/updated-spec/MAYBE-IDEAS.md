...
- **Complexity:** Non-trivial — needs state tracking (recent request hashes) or bridge-level dedup. v1.5 mentions idempotency but doesn't detail this specific case.
