...
- `add_projects`, `edit_projects` -- deferred to v1.5. Project writes have unverified OmniJS APIs (Project.Status, Project.ReviewInterval, markReviewed) and are low priority for the user's workflow (tasks are promoted to projects manually).
