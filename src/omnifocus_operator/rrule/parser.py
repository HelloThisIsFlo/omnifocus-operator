...
Parses the OmniFocus RRULE subset into the flat Frequency model with
6 types and optional specialization fields.
...
def parse_rrule(rule_string: str) -> Frequency:
    ...
    Returns a Frequency model with type and optional specialization fields.
...
def _parse_monthly_bymonthday(
    ...
    """Parse BYMONTHDAY for monthly frequency with on_dates.
