...
# ---------------------------------------------------------------------------
# PROP-07: project writes for completesWithChildren / type are deferred to v1.5
# ---------------------------------------------------------------------------


# PROP-07 checkpoint: when v1.5 introduces project writes, these tests
...
class TestPROP07ProjectWritesNotYetAvailable:
    """PROP-07: project writes for `completesWithChildren` and `type` are deferred to v1.5.
    ...
    affirms that structural absence so v1.5 lands with an explicit
    ...
    async def test_no_add_projects_tool_registered(self, client: Any) -> None:
        ...
        assert not project_write_tools, (
            f"PROP-07: v1.4.1 defers project writes to v1.5. "
    ...
    async def test_task_write_tools_exist_but_no_project_write_tool_does(
        ...
        two task-write tools, zero project-write tools. When v1.5 adds the
